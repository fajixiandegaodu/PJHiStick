...
import static com.example.istick.BlueTooth.BluetoothConnect.EXTRAS_DEVICE_ADDRESS;
import static com.example.istick.BlueTooth.BluetoothConnect.EXTRAS_DEVICE_NAME;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
           ...
           public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
               ...
               Log.e("connect","正在连接设备："+device.name);
              ...
              /*为用户显示少量信息*/
               ...
               if (device.getMac().length()==17){
                   /*进行activity直接的跳转*/
                   Intent intent = new Intent(ScanActivity.this, BluetoothConnect.class);
                   /*传递数据给另一个Activity*/
